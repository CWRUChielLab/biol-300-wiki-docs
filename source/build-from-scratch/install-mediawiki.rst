...
4.  Download the source code for the latest version of MediaWiki with long term
    ...
    :doc:`/update-mediawiki`). As of December 2016, the latest LTS version is
...
6.  Create and initializing the wiki database (do not forget to fill in
    the passwords)::
        ...
        php /var/www/mediawiki/maintenance/install.php --dbname wikidb --dbuser root --dbpass <MySQL password> --pass <wiki admin password> "BIOL 300 Wiki" Hjc
